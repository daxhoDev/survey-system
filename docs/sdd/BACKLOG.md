...
| BL-08 | **Hide inactive surveys from anonymous users** on `GET /surveys/:slug`: `optionalAuth` middleware (AUTH-22), `404` without session, `401` for an expired session on an inactive survey. | SURV-12, AUTH-22, FE-24 |
